...
def confirmation_window(link,res):
    ...
    label1 = tk.Label(master=frame1, text="Please confirm your download", bg="#4ac74a", fg="black", height=2, width=30)
    ...
    button1 = tk.Button(master=frame1, text="Download", command= lambda: download(details[3]))
    button2 = tk.Button(master=frame1, text="Cancel", command= lambda: close_window(window1, True, True))
...
def success_window():
    ...
    label1 = tk.Label(master=frame1, text="Successful!", bg="#0ce813", fg="black", height=2, width=20)
    button1 = tk.Button(master=frame1, text="OK", width=5, command=lambda: close_window(window2, True, True))
...
def error_window(message):
    ...
    label1 = tk.Label(master=frame1, text=message, bg="#87010a", fg="white", height=2, width=30)
    if message=="Invalid link":
        button1 = tk.Button(master=frame1, text="OK", width=6, command=lambda : close_window(window3, True, False))
    else:
        button1 = tk.Button(master=frame1, text="OK", width=6, command=lambda : close_window(window3, False, True))
...
label1 = tk.Label(master=frame1, text="Welcome to the YouTube Downloader", fg="white", bg="black", width=40, height=4)
label2 = tk.Label(master=frame1, text="Enter the Link:", fg="white", bg="red", width=20, height=2)
...
button1 = tk.Button(master=frame2, text="Download", fg="black", bg="#4ac74a", width=15, height=2, command=click_download)
